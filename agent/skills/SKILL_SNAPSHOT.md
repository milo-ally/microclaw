<available_skills>
  ...
  <skill>
    ...
    <description>Follow the skills' detail when user ask you to plan. Creating a json file to help you form a todo list, use mentioned python scripts to update the todo list.</description>
